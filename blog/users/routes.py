...
from blog.users.form import RegistrationForm, LoginForm, UpdateAccountForm, RequestPasswordResetForm, ResetPasswordForm
from blog.model import User, Event
from flask_login import login_user, current_user, logout_user, login_required
from blog.users.utils import saveProfilePicture, sendResetPasswordEmail, sendWelcomeEmail
...
#forgot password  - requesting to  reset the password. User enters their email where reset instructions will be sent
